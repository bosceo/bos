package stest.bos.wallet.dailybuild.tvmnewcommand.transferfailed;

import static org.bos.protos.Protocol.TransactionInfo.code.FAILED;
...
public class TransferFailed001 {
  ...
  public void test001TransferBosInsufficientBalance() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferBosInsufficientBalance(uint256)", num, false,
  ...
  public void test003TransferBosNonexistentTarget() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferBosNonexistentTarget(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
  ...
  public void test004TransferBosSelf() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferBosSelf(uint256)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);
    ...
    Assert.assertEquals("transfer trx failed: Cannot transfer BOS to yourself.",
        ByteArray.toStr(infoById.get().getResMessage().toByteArray()));
  ...
  public void test005TransferBosNonexistentTarget() {
  ...
  public void test006TransferBosSelf() {
  ...
  @Test(enabled = true, description = "transferBos to nonexistent target ,but revert")
  public void test010TransferRevert() {
    ...
    txid = PublicMethed.triggerContract(contractAddress,
        "testTransferBosrevert(uint256,address)", num, false,
        0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);

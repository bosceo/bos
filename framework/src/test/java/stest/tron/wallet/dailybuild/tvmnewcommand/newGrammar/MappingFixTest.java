package stest.bos.wallet.dailybuild.tvmnewcommand.newGrammar;
...
public class MappingFixTest {
  ...
  // Bos Solidity compiler is no longer compatible with Ethereum
  // Bos handles 41 Address in contract, and Ethereum do not

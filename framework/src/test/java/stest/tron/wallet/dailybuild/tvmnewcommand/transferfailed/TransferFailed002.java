...
public class TransferFailed002 {
  ...
  public void test1SendNotEnough() {
    ...
    String num = "3000001";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendBosInsufficientBalance(uint256)", num, false, 0,
  ...
  public void test3SendBosNonexistentTarget() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendBosNonexistentTarget(uint256,address)", num,
  ...
  public void test4SendBosSelf() {
    ...
    String num = "1";
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendBosSelf(uint256)", num, false, 0, maxFeeLimit,
  ...
  public void test5SendBosNonexistentTarget() {
    Account info;
  ...
  public void test7SendBosNonexistentTargetRevert() {
    ...
    txid = PublicMethed
        .triggerContract(contractAddress, "testSendBosRevert(uint256,address)", num, false, 0,
            maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    Optional<TransactionInfo> infoById = null;
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethed.getTransactionInfoById(txid, blockingStubFull);

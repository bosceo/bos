...
public class ContractScenario015 {
  ...
  @Test(enabled = true, description = "BOS TRC20 transfer token")
  public void trc20Bos() {
    ...
    String contractName = "BOS TRC20";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_Scenario015_TRC20_BOS");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_Scenario015_TRC20_BOS");

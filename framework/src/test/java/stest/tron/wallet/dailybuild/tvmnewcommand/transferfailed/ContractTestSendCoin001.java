...
import static org.bos.api.GrpcAPI.Return.response_code.CONTRACT_VALIDATE_ERROR;
import static org.bos.protos.Protocol.Transaction.Result.contractResult.SUCCESS_VALUE;
...
public class ContractTestSendCoin001 {
  ...
  public void testSendCoinAndTransferAssetContract001() {
    ...
    Assert.assertEquals("contract validate error : Cannot transfer BOS to a smartContract.",

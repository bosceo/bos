package stest.bos.wallet.dailybuild.tvmnewcommand.batchValidateSignContract;
...
import stest.bos.wallet.common.client.Parameter;
...
public class batchValidateSignContract001 {
  ...
  public void test01Correct16signatures() {
    ...
    if (transactionExtention.getResult().getCode().toString().equals("CONTRACT_EXE_ERROR")) {
      Assert.assertEquals("class org.bos.common.runtime.vm.program.Program$OutOfTimeException "

package stest.bos.wallet.dailybuild.delaytransaction;
...
public class DelayTransaction005 {
  ...
  public void test1DelayUpdateSetting() {
    ...
    String contractName = "BOSTOKEN";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractScenario004_deployErc20BosToken");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractScenario004_deployErc20BosToken");

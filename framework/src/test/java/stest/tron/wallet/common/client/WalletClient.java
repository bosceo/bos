...
import static stest.bos.wallet.common.client.utils.PublicMethed.decode58Check;
...
import org.bos.protos.contract.AssetIssueContractOuterClass;
...
import org.bos.protos.contract.WitnessContract;
import stest.bos.wallet.common.client.Parameter.CommonConstant;
import stest.bos.wallet.common.client.utils.Base58;
import stest.bos.wallet.common.client.utils.TransactionUtils;
...
public class WalletClient {
  ...
  public static GrpcClient init() {
    //Config config = org.bos.core.config.Configuration.getByPath("config.conf");
    Config config = Configuration.getByPath("testng.conf");
    dbPath = config.getString("CityDb.DbPath");
    txtPath = System.getProperty("user.dir") + "/" + config.getString("CityDb.TxtPath");

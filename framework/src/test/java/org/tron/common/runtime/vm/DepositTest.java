...
public class DepositTest {
  ...
  public void loopCallTest()
    ...
    Runtime runtime = TvmTestUtils
        .processTransactionAndReturnRuntime(aBos, DepositImpl.createRoot(manager),
            null);
    ...
    byte[] aAddress = WalletUtil.generateContractAddress(aBos);
    byte[] bAddress = WalletUtil.generateContractAddress(bBos);
  ...
  public void loopCallTestOldVersion()
    ...
    Runtime runtime = TvmTestUtils.processTransactionAndReturnRuntime(aBos, rootDeposit,
        null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Transaction bBos = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null);
    rootDeposit = DepositImpl.createRoot(manager);
    runtime = TvmTestUtils.processTransactionAndReturnRuntime(bBos, rootDeposit, null);
    Assert.assertNull(runtime.getRuntimeError());

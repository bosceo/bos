...
import org.bos.core.vm.program.invoke.ProgramInvokeMockImpl;
...
public class InterpreterTest {
  ...
  public void testVMException() throws ContractValidateException {
    ...
    InternalTransaction interBos = new InternalTransaction(trx, BosType.BOS_UNKNOWN_TYPE);
    program = new Program(op, invoke, interBos);

...
import org.bos.protos.Protocol.DisconnectMessageOrBuilder;
...
public class DisconnectMessageTest extends com.google.protobuf.GeneratedMessageV3 implements
   ...
   * <code>.protocol.ReasonCode reason = 1;</code>
   */
  public org.bos.protos.Protocol.ReasonCode getReason() {
    org.bos.protos.Protocol.ReasonCode result = org.bos.protos.Protocol.ReasonCode
        .valueOf(reason_);
    return result == null ? org.bos.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }

  public org.bos.protos.Protocol.ReasonCode getName() {
    org.bos.protos.Protocol.ReasonCode result = org.bos.protos.Protocol.ReasonCode.valueOf(name_);
    return result == null ? org.bos.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (reason_ != org.bos.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
      output.writeEnum(1, reason_);
    }
    if (name_ != org.bos.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {

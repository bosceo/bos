package org.bos.core.net.services;
...
public class AdvServiceTest {
  ...
  private void testAddInv() {
    boolean flag;
    Item itemBos = new Item(Sha256Hash.ZERO_HASH, InventoryType.BOS);
    flag = service.addInv(itemBos);
  ...
  private void testBosBroadcast() {
    ...
    service.broadcast(msg);
    Item item = new Item(msg.getMessageId(), InventoryType.BOS);
    Assert.assertNotNull(service.getMessage(item));
  }

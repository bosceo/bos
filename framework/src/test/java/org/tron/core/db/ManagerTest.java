...
import static org.bos.common.utils.Commons.adjustAssetBalanceV2;
import static org.bos.common.utils.Commons.adjustBalance;
import static org.bos.common.utils.Commons.adjustTotalShieldedPoolValue;
...
import org.bos.consensus.dpos.DposSlot;
...
public class ManagerTest extends BlockGenerate {
  ...
  public void updateWits() {
    ...
    WitnessCapsule witnessCapsulef =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0011")), "www.bos.net/first");
    ...
    WitnessCapsule witnessCapsulet =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0013")), "www.bos.net/three");

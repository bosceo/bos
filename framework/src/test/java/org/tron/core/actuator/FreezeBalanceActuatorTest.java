...
import static org.bos.core.config.Parameter.ChainConstant.TRANSFER_FEE;
...
import org.bos.protos.contract.Common.ResourceCode;
...
public class FreezeBalanceActuatorTest {
  ...
  public void testFreezeBalanceForBandwidth() {
    ...
    try {
      ...
      Assert.assertEquals(frozenBalance, owner.getBosPower());
  ...
  public void testFreezeDelegatedBalanceForBandwidth() {
    ...
    try {
      ...
      Assert.assertEquals(0L, receiver.getBosPower());
  ...
  public void lessThan1BosTest() {
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("frozenBalance must be more than 1BOS", e.getMessage());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    }
  }

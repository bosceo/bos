...
import static org.bos.core.config.Parameter.ChainSymbol.BOS_SYMBOL_BYTES;
...
public class ExchangeTransactionActuatorTest {
  ...
  private void InitExchangeBeforeSameTokenNameActive() {
    ...
    ExchangeCapsule exchangeCapsule =
        new ExchangeCapsule(
            ...
            BOS_SYMBOL_BYTES,
            "abc".getBytes());
    exchangeCapsule.setBalance(1_000_000_000_000L, 10_000_000L); // 1M BOS == 10M abc
    ...
    ExchangeCapsule exchangeCapsule3 =
        new ExchangeCapsule(
            ...
            BOS_SYMBOL_BYTES,
            "1".getBytes());
    exchangeCapsule3.setBalance(1_000_000_000_000L, 10_000_000L); // 1M BOS == 10M abc
  ...
  public void SameTokenNameCloseSuccessExchangeTransaction() {
    ...
    long exchangeId = 1;
    String tokenId = "_";
    long quant = 100_000_000L; // use 100 BOS to buy abc

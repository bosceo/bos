...
import org.bos.protos.Protocol.Vote;
...
public class UnfreezeBalanceActuatorTest {
  ...
  public void testUnfreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getBosPower(), frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getBosPower(), 0L);
  ...
  public void testUnfreezeDelegatedBalanceForBandwidth() {
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getBosPower());

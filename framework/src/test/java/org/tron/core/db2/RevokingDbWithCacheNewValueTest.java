...
public class RevokingDbWithCacheNewValueTest {
  ...
  public synchronized void testPop() throws RevokingStoreIllegalStateException {
    ...
    bosDatabase = new TestRevokingBosStore("testRevokingDBWithCacheNewValue-testPop");
  ...
  public synchronized void testMerge() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    bosDatabase = new TestRevokingBosStore("testRevokingDBWithCacheNewValue-testMerge");
    revokingDatabase.add(bosDatabase.getRevokingDB());
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      bosDatabase.put(testProtoCapsule.getData(), testProtoCapsule2);
      tmpSession.merge();
    }
    Assert.assertEquals(testProtoCapsule2, bosDatabase.get(testProtoCapsule.getData()));

    try (ISession tmpSession = revokingDatabase.buildSession()) {
      bosDatabase.delete(testProtoCapsule.getData());
      tmpSession.merge();
    }
    Assert.assertEquals(null, bosDatabase.get(testProtoCapsule.getData()));
    dialog.reset();
  }
  ...
  public synchronized void testRevoke() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    bosDatabase = new TestRevokingBosStore("testRevokingDBWithCacheNewValue-testRevoke");
    revokingDatabase.add(bosDatabase.getRevokingDB());
    ...
    try (ISession tmpSession = revokingDatabase.buildSession()) {
      bosDatabase.put(testProtoCapsule.getData(), new ProtoCapsuleTest("revoke22".getBytes()));
      tmpSession.merge();
    }

    try (ISession tmpSession = revokingDatabase.buildSession()) {
      bosDatabase.put(testProtoCapsule.getData(), new ProtoCapsuleTest("revoke222".getBytes()));
      tmpSession.merge();
    }
    ...
    Assert.assertEquals(testProtoCapsule, bosDatabase.get(testProtoCapsule.getData()));
  }
  ...
  public synchronized void testGetlatestValues() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    bosDatabase = new TestRevokingBosStore("testSnapshotManager-testGetlatestValues");
    revokingDatabase.add(bosDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
  ...
  public synchronized void testGetValuesNext() {
    revokingDatabase = context.getBean(SnapshotManager.class);
    revokingDatabase.enable();
    bosDatabase = new TestRevokingBosStore("testSnapshotManager-testGetValuesNext");
    revokingDatabase.add(bosDatabase.getRevokingDB());
    while (revokingDatabase.size() != 0) {
      revokingDatabase.pop();
    }
  ...
  public static class TestRevokingBosStore extends BosStoreWithRevoking<ProtoCapsuleTest> {

    protected TestRevokingBosStore(String dbName) {
      super(dbName);
    }

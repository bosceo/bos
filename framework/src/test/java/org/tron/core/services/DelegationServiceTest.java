...
import static stest.bos.wallet.common.client.Parameter.CommonConstant.ADD_PRE_FIX_BYTE_MAINNET;
...
public class DelegationServiceTest {
  ...
  public DelegationServiceTest(BosApplicationContext context) {

...
import org.bos.common.zksnark.LibrustzcashParam.BindingSigParams;
import org.bos.common.zksnark.LibrustzcashParam.CheckOutputParams;
import org.bos.common.zksnark.LibrustzcashParam.CheckSpendParams;
import org.bos.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.bos.common.zksnark.LibrustzcashParam.OutputProofParams;
...
import org.bos.core.actuator.ActuatorCreator;
...
import org.bos.core.capsule.ReceiveDescriptionCapsule;
import org.bos.core.capsule.SpendDescriptionCapsule;
...
import org.bos.core.consensus.ConsensusService;
import org.bos.core.db.BlockGenerate;
...
import org.bos.core.services.http.FullNodeHttpApiService;
import org.bos.core.utils.TransactionUtil;
import org.bos.core.zen.ZenTransactionBuilder;
import org.bos.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.bos.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
...
import org.bos.core.zen.note.Note.NotePlaintextEncryptionResult;
import org.bos.core.zen.note.NoteEncryption;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static final int BOS_NUM = 10;
  private static final int NUM = 1;
  private static final long START_TIME = 1;
  private static final long END_TIME = 2;
  private static final int VOTE_SCORE = 2;
  private static final String DESCRIPTION = "BOS";
  private static final String URL = "https://bos.network";
  ...
  private static byte[] randomUint256() {
    return org.bos.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.bos.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.bos.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.bos.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.bos.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.bos.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.bos.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.bos.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.bos.keystore.Wallet.generateRandomBytes(512);
    ...
    for (int i = 0; i < 1; i++) {
      org.bos.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.bos.keystore.Wallet.generateRandomBytes(512);
  ...
  public void decodePaymentAddressIgnoreCase() {
    String addressLower =
        "zbos1975m0wyg8f30cgf2l5fgndhzqzkzgkgnxge8cwx2wr7m3q7chsuwewh2e6u24yykum0hq8ue99u";

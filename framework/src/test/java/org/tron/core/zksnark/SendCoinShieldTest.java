...
import static org.bos.core.capsule.TransactionCapsule.getShieldTransactionHashIgnoreTypeException;
...
import org.bos.common.zksnark.IncrementalMerkleTreeContainer.EmptyMerkleRoots;
...
import org.bos.common.zksnark.LibrustzcashParam.ComputeCmParams;
import org.bos.common.zksnark.LibrustzcashParam.FinalCheckParams;
...
import org.bos.common.zksnark.MerklePath;
import org.bos.common.zksnark.ZksnarkClient;
...
import org.bos.core.actuator.ShieldedTransferActuator;
...
public class SendCoinShieldTest {
  ...
  public void createCapsule() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setId(Long.toString(tokenId)).setTotalSupply(OWNER_BALANCE).setBosNum(BOS_NUM).setNum(NUM)

...
public class AccountVoteWitnessTest {
  ...
  private List<AccountCapsule> getAccountList() {
    ...
    final AccountCapsule accountBos =
        new AccountCapsule(
            ByteString.copyFrom("00000000001".getBytes()),
            ByteString.copyFromUtf8("Bos"),
            AccountType.Normal);
    ...
    final AccountCapsule accountVivider =
        new AccountCapsule(
            ...
            AccountType.Normal);
    // accountBos addVotes
    accountBos.addVotes(accountMarcus.getAddress(), 100);
    accountBos.addVotes(accountOlivier.getAddress(), 100);
    accountBos.addVotes(accountSasaXie.getAddress(), 100);
    accountBos.addVotes(accountVivider.getAddress(), 100);

    // accountMarcus addVotes
    accountMarcus.addVotes(accountBos.getAddress(), 100);
    ...
    accountOlivier.addVotes(accountBos.getAddress(), 100);
    ...
    accountCapsuleList.add(accountBos);
  ...
  private List<WitnessCapsule> getWitnessList() {
    ...
    final WitnessCapsule witnessBos =
    ...
    witnessCapsuleList.add(witnessBos);

contract EnergyOfTransferFailedTest {
    ...
    function testCallBosInsufficientBalance(uint256 i,address payable caller) public {
    ...
    function testSendBosNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
    }

    function testSendBosRevert(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
        revert();
    }

    function testTransferBosNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.transfer(i);
    }

    function testTransferBosrevert(uint256 i,address payable nonexistentTarget) payable public{
        nonexistentTarget.transfer(i);
        revert();
    }
    ...
    function testCallBosNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {

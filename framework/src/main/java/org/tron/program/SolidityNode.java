...
import org.bos.common.overlay.client.DatabaseGrpcClient;
...
import org.bos.core.services.http.solidity.SolidityNodeHttpApiService;
...
public class SolidityNode {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new BosApplicationContext(DefaultConfig.class);
    ...
    nodeManager.close();
    BosNetService bosNetService = context.getBean(BosNetService.class);
    bosNetService.stop();

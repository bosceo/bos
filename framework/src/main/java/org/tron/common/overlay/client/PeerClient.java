...
import org.bos.common.overlay.server.BosChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "BosJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    BosChannelInitializer bosChannelInitializer = ctx
        .getBean(BosChannelInitializer.class, remoteId);
    bosChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(bosChannelInitializer);

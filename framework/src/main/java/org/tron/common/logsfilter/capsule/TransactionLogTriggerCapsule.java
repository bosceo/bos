...
import static org.bos.protos.Protocol.Transaction.Contract.ContractType.TransferAssetContract;
import static org.bos.protos.Protocol.Transaction.Contract.ContractType.TransferContract;
...
import org.bos.common.logsfilter.trigger.InternalTransactionPojo;
import org.bos.common.logsfilter.trigger.TransactionLogTrigger;
...
public class TransactionLogTriggerCapsule extends TriggerCapsule {
  ...
  public TransactionLogTriggerCapsule(TransactionCapsule trxCasule, BlockCapsule blockCapsule) {
    ...
    TransactionTrace trxTrace = trxCasule.getBosTrace();

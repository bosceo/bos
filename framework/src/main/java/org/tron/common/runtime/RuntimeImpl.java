...
import org.bos.core.actuator.Actuator2;
...
import org.bos.core.vm.program.Program.BadJumpDestinationException;
import org.bos.core.vm.program.Program.IllegalOperationException;
...
import org.bos.core.vm.program.Program.OutOfMemoryException;
import org.bos.core.vm.program.Program.OutOfTimeException;
import org.bos.core.vm.program.Program.PrecompiledContractException;
import org.bos.core.vm.program.Program.StackTooLargeException;
import org.bos.core.vm.program.Program.StackTooSmallException;
...
public class RuntimeImpl implements Runtime {
  ...
  public void execute(TransactionContext context)
    ...
    ContractType contractType = context.getBosCap().getInstance().getRawData().getContract(0)
        .getType();
    switch (contractType.getNumber()) {
      ...
      case ContractType.CreateSmartContract_VALUE:
        ...
        break;
      default:
        actuatorList = ActuatorCreator.getINSTANCE().createActuator(context.getBosCap());
    }
    if (actuator2 != null) {

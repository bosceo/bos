...
import org.bos.api.DatabaseGrpc.DatabaseImplBase;
import org.bos.api.GrpcAPI;
import org.bos.api.GrpcAPI.AccountNetMessage;
import org.bos.api.GrpcAPI.AccountResourceMessage;
import org.bos.api.GrpcAPI.Address;
import org.bos.api.GrpcAPI.AddressPrKeyPairMessage;
import org.bos.api.GrpcAPI.AssetIssueList;
import org.bos.api.GrpcAPI.BlockExtention;
import org.bos.api.GrpcAPI.BlockLimit;
import org.bos.api.GrpcAPI.BlockList;
import org.bos.api.GrpcAPI.BlockListExtention;
import org.bos.api.GrpcAPI.BlockReference;
import org.bos.api.GrpcAPI.BytesMessage;
import org.bos.api.GrpcAPI.DecryptNotes;
import org.bos.api.GrpcAPI.DecryptNotesMarked;
import org.bos.api.GrpcAPI.DelegatedResourceList;
import org.bos.api.GrpcAPI.DelegatedResourceMessage;
import org.bos.api.GrpcAPI.DiversifierMessage;
import org.bos.api.GrpcAPI.EasyTransferAssetByPrivateMessage;
import org.bos.api.GrpcAPI.EasyTransferAssetMessage;
import org.bos.api.GrpcAPI.EasyTransferByPrivateMessage;
import org.bos.api.GrpcAPI.EasyTransferMessage;
import org.bos.api.GrpcAPI.EasyTransferResponse;
import org.bos.api.GrpcAPI.EmptyMessage;
import org.bos.api.GrpcAPI.ExchangeList;
import org.bos.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.bos.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
import org.bos.api.GrpcAPI.IncomingViewingKeyMessage;
import org.bos.api.GrpcAPI.Node;
import org.bos.api.GrpcAPI.NodeList;
import org.bos.api.GrpcAPI.NoteParameters;
import org.bos.api.GrpcAPI.NumberMessage;
import org.bos.api.GrpcAPI.PaginatedMessage;
import org.bos.api.GrpcAPI.PaymentAddressMessage;
import org.bos.api.GrpcAPI.PrivateParameters;
import org.bos.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.bos.api.GrpcAPI.ProposalList;
import org.bos.api.GrpcAPI.Return;
import org.bos.api.GrpcAPI.Return.response_code;
import org.bos.api.GrpcAPI.ShieldedAddressInfo;
import org.bos.api.GrpcAPI.SpendAuthSigParameters;
import org.bos.api.GrpcAPI.SpendResult;
import org.bos.api.GrpcAPI.TransactionApprovedList;
import org.bos.api.GrpcAPI.TransactionExtention;
import org.bos.api.GrpcAPI.TransactionInfoList;
import org.bos.api.GrpcAPI.TransactionList;
import org.bos.api.GrpcAPI.TransactionListExtention;
import org.bos.api.GrpcAPI.TransactionSignWeight;
import org.bos.api.GrpcAPI.ViewingKeyMessage;
import org.bos.api.GrpcAPI.WitnessList;
import org.bos.api.MonitorGrpc;
import org.bos.api.WalletExtensionGrpc;
import org.bos.api.WalletGrpc.WalletImplBase;
import org.bos.api.WalletSolidityGrpc.WalletSolidityImplBase;
import org.bos.common.application.Service;
import org.bos.common.crypto.ECKey;
import org.bos.common.crypto.SignInterface;
import org.bos.common.crypto.SignUtils;
import org.bos.common.overlay.discover.node.NodeHandler;
...
import org.bos.common.utils.Utils;
...
import org.bos.core.exception.NonUniqueObjectException;
...
import org.bos.core.metrics.MetricsApiService;
import org.bos.core.services.ratelimiter.RateLimiterInterceptor;
...
import org.bos.protos.Protocol.Account;
import org.bos.protos.Protocol.Block;
import org.bos.protos.Protocol.DynamicProperties;
import org.bos.protos.Protocol.Exchange;
import org.bos.protos.Protocol.NodeInfo;
...
import org.bos.protos.Protocol.TransactionSign;
import org.bos.protos.contract.AccountContract.AccountCreateContract;
import org.bos.protos.contract.AccountContract.AccountPermissionUpdateContract;
import org.bos.protos.contract.AccountContract.AccountUpdateContract;
import org.bos.protos.contract.AccountContract.SetAccountIdContract;
import org.bos.protos.contract.AssetIssueContractOuterClass.AssetIssueContract;
import org.bos.protos.contract.AssetIssueContractOuterClass.ParticipateAssetIssueContract;
import org.bos.protos.contract.AssetIssueContractOuterClass.TransferAssetContract;
import org.bos.protos.contract.AssetIssueContractOuterClass.UnfreezeAssetContract;
import org.bos.protos.contract.AssetIssueContractOuterClass.UpdateAssetContract;
import org.bos.protos.contract.BalanceContract.FreezeBalanceContract;
import org.bos.protos.contract.BalanceContract.TransferContract;
import org.bos.protos.contract.BalanceContract.UnfreezeBalanceContract;
import org.bos.protos.contract.BalanceContract.WithdrawBalanceContract;
import org.bos.protos.contract.ExchangeContract.ExchangeCreateContract;
import org.bos.protos.contract.ExchangeContract.ExchangeInjectContract;
import org.bos.protos.contract.ExchangeContract.ExchangeTransactionContract;
import org.bos.protos.contract.ExchangeContract.ExchangeWithdrawContract;
import org.bos.protos.contract.ProposalContract.ProposalApproveContract;
import org.bos.protos.contract.ProposalContract.ProposalCreateContract;
import org.bos.protos.contract.ProposalContract.ProposalDeleteContract;
import org.bos.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.bos.protos.contract.ShieldContract.OutputPointInfo;
import org.bos.protos.contract.SmartContractOuterClass.ClearABIContract;
import org.bos.protos.contract.SmartContractOuterClass.CreateSmartContract;
import org.bos.protos.contract.SmartContractOuterClass.SmartContract;
import org.bos.protos.contract.SmartContractOuterClass.TriggerSmartContract;
import org.bos.protos.contract.SmartContractOuterClass.UpdateEnergyLimitContract;
import org.bos.protos.contract.SmartContractOuterClass.UpdateSettingContract;
import org.bos.protos.contract.StorageContract.UpdateBrokerageContract;
import org.bos.protos.contract.WitnessContract.VoteWitnessContract;
import org.bos.protos.contract.WitnessContract.WitnessCreateContract;
import org.bos.protos.contract.WitnessContract.WitnessUpdateContract;
...
public class RpcApiService implements Service {
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.bos.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.bos.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletSolidityApi extends WalletSolidityImplBase {
    ...
    public void getDelegatedResourceAccountIndex(BytesMessage request,
        StreamObserver<org.bos.protos.Protocol.DelegatedResourceAccountIndex> responseObserver) {
      responseObserver
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      Preconditions.checkArgument(account.getBosPower() < votesCount,
          "bos power[" + account.getBosPower() + "] <  VotesCount[" + votesCount + "]");
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            org.bos.common.overlay.discover.node.Node node = v.getValue().getNode();

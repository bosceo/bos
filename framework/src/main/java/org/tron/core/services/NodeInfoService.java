...
import org.bos.common.entity.NodeInfo.ConfigNodeInfo;
import org.bos.common.entity.NodeInfo.MachineInfo;
import org.bos.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.bos.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.bos.common.entity.PeerInfo;
...
import org.bos.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getBosLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getBosLastRemoteDisconnectReason();

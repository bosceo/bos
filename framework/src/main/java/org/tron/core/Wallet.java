...
package org.bos.core;

import static org.bos.common.utils.Commons.getAssetIssueStoreFinal;
import static org.bos.common.utils.Commons.getExchangeStoreFinal;
import static org.bos.common.utils.WalletUtil.isConstant;
import static org.bos.core.config.Parameter.ChainConstant.BLOCK_PRODUCED_INTERVAL;
import static org.bos.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.bos.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.bos.api.GrpcAPI.TransactionExtention.Builder;
...
import org.bos.common.zksnark.IncrementalMerkleTreeContainer;
import org.bos.common.zksnark.IncrementalMerkleVoucherContainer;
import org.bos.common.zksnark.JLibrustzcash;
import org.bos.common.zksnark.LibrustzcashParam.ComputeNfParams;
import org.bos.common.zksnark.LibrustzcashParam.CrhIvkParams;
import org.bos.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.bos.common.zksnark.LibrustzcashParam.SpendSigParams;
import org.bos.core.actuator.Actuator;
import org.bos.core.actuator.ActuatorFactory;
import org.bos.core.actuator.VMActuator;
...
import org.bos.core.capsule.DelegatedResourceCapsule;
import org.bos.core.capsule.ExchangeCapsule;
import org.bos.core.capsule.IncrementalMerkleTreeCapsule;
import org.bos.core.capsule.IncrementalMerkleVoucherCapsule;
import org.bos.core.capsule.PedersenHashCapsule;
...
import org.bos.core.db.BandwidthProcessor;
import org.bos.core.db.EnergyProcessor;
...
import org.bos.core.exception.HeaderNotFound;
import org.bos.core.exception.ItemNotFoundException;
import org.bos.core.exception.NonUniqueObjectException;
import org.bos.core.exception.PermissionException;
import org.bos.core.exception.SignatureFormatException;
...
import org.bos.core.store.AccountIdIndexStore;
...
import org.bos.core.zen.ZenTransactionBuilder;
...
import org.bos.core.zen.address.KeyIo;
import org.bos.core.zen.address.PaymentAddress;
import org.bos.core.zen.address.SpendingKey;
import org.bos.core.zen.note.Note;
import org.bos.core.zen.note.NoteEncryption.Encryption;
import org.bos.core.zen.note.OutgoingPlaintext;
...
import org.bos.protos.contract.ShieldContract.IncrementalMerkleTree;
...
import org.bos.protos.contract.ShieldContract.PedersenHash;
import org.bos.protos.contract.ShieldContract.ReceiveDescription;
...
public class Wallet {
  ...
  private void setTransaction(TransactionCapsule trx) {
    try {
      ...
      if ("solid".equals(Args.getInstance().getBosReferenceBlock())) {
      ...
      long expiration = chainBaseManager.getHeadBlockTimeStamp() + Args.getInstance()
          .getBosExpirationTimeInMilliseconds();
  ...
  public GrpcAPI.Return broadcastTransaction(Transaction signedTransaction) {
    ...
    try {
      ...
      if (minEffectiveConnection != 0) {
        if (bosNetDelegate.getActivePeer().isEmpty()) {
          logger
        ...
        int count = (int) bosNetDelegate.getActivePeer().stream()
      ...
      bosNetService.broadcast(message);
  ...
  public DiversifierMessage getDiversifier() throws ZksnarkException {
    ...
    byte[] d;
    while (true) {
      d = org.bos.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.bos.common.overlay.discover.node.Node node = v.getValue()
              .getNode();

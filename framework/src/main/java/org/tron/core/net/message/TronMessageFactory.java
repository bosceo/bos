...
import org.bos.common.overlay.message.MessageFactory;
 ...
 * msg factory.
 */
public class BosMessageFactory extends MessageFactory {

  private static final String DATA_LEN = ", len=";

  @Override
  public BosMessage create(byte[] data) throws Exception {
  ...
  private BosMessage create(byte type, byte[] packed) throws Exception {

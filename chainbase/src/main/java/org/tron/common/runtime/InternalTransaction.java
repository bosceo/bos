...
public class InternalTransaction {
   ...
   */
  public InternalTransaction(Transaction trx, InternalTransaction.BosType trxType)
    ...
    this.deep = -1;
    if (trxType == BosType.BOS_CONTRACT_CREATION_TYPE) {
    ...
    } else if (trxType == BosType.BOS_CONTRACT_CALL_TYPE) {
  ...
  public enum BosType {
    BOS_PRECOMPILED_TYPE,
    BOS_CONTRACT_CREATION_TYPE,
    BOS_CONTRACT_CALL_TYPE,
    BOS_UNKNOWN_TYPE,
  }

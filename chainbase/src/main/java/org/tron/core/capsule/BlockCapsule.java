...
import org.bos.core.capsule.utils.MerkleTree;
...
public class BlockCapsule implements ProtoCapsule<Block> {
  ...
  public void addTransaction(TransactionCapsule pendingBos) {
    this.block = this.block.toBuilder().addTransactions(pendingBos.getInstance()).build();
    getTransactions().add(pendingBos);
  }

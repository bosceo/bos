...
import org.bos.core.db2.common.IRevokingDB;
import org.bos.core.db2.common.LevelDB;
import org.bos.core.db2.common.RocksDB;
import org.bos.core.db2.core.Chainbase;
import org.bos.core.db2.core.IBosChainBase;
import org.bos.core.db2.core.RevokingDBWithCachingOldValue;
...
@Slf4j(topic = "DB")
public abstract class BosStoreWithRevoking<T extends ProtoCapsule> implements IBosChainBase<T> {
  ...
  protected BosStoreWithRevoking(String dbName) {
  ...
  protected BosStoreWithRevoking(DB<byte[], byte[]> db) {
    int dbVersion = CommonParameter.getInstance().getStorage().getDbVersion();
    if (dbVersion == 2) {
  ...
  // only for test
  protected BosStoreWithRevoking(String dbName, RevokingDatabase revokingDatabase) {
    this.revokingDB = new RevokingDBWithCachingOldValue(dbName,

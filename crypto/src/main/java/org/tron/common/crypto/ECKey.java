...
import org.bos.common.crypto.jce.ECKeyAgreement;
import org.bos.common.crypto.jce.ECKeyFactory;
import org.bos.common.crypto.jce.ECKeyPairGenerator;
import org.bos.common.crypto.jce.ECSignatureFactory;
import org.bos.common.crypto.jce.BosCastleProvider;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(BosCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = BosCastleProvider.getInstance();
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(BosCastleProvider.getInstance())

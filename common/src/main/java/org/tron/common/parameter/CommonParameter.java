package org.bos.common.parameter;
...
import org.bos.core.config.args.Overlay;
import org.bos.core.config.args.SeedNode;
import org.bos.core.config.args.Storage;
...
public class CommonParameter {
  ...
  @Parameter(names = {"--contract-parse-enable"},
      description = "enable contract parses in java-bos or not.(true or false)")
  ...
  //If you are running a solidity node for java bos, this flag is set to true
  @Getter
  @Setter
  ...
  @Getter
  @Setter
  public long netMaxBosPerSecond;
  @Getter
  @Setter

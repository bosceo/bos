...
public class Constant {
  ...
  public static final long SUN_PER_ENERGY = 100; // 1 us = 100 SUN = 100 * 10^-6 BOS
  ...
  public static final byte[] ZBOS_EXPANDSEED_PERSONALIZATION = {'Z', 't', 'r', 'o', 'n', '_', 'E',
      'x',
      'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
  ...
  public static final String NODE_NET_MAX_BOS_PER_SECOND = "node.netMaxBosPerSecond";
  ...
  public static final String BOS_REFERENCE_BLOCK = "trx.reference.block";

  public static final String BOS_EXPIRATION_TIME_IN_MILLIS_SECONDS = "trx.expiration.timeInMilliseconds";

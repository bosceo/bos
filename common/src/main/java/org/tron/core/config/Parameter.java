...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] BOS_SYMBOL_BYTES = "_".getBytes(); // BOS symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final long BOS_PRECISION = 1000_000L;
  }

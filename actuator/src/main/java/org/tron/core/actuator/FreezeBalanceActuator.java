...
import static org.bos.core.config.Parameter.ChainConstant.FROZEN_PERIOD;
...
public class FreezeBalanceActuator extends AbstractActuator {
  ...
  public boolean execute(Object result) throws ContractExeException {
    ...
    switch (freezeBalanceContract.getResource()) {
      case BANDWIDTH:
        ...
        dynamicStore
            .addTotalNetWeight(frozenBalance / BOS_PRECISION);
        break;
      case ENERGY:
        if (!ArrayUtils.isEmpty(receiverAddress)
            && dynamicStore.supportDR()) {
        ...
        dynamicStore
            .addTotalEnergyWeight(frozenBalance / BOS_PRECISION);
        break;
      default:
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (frozenBalance < BOS_PRECISION) {
      throw new ContractValidateException("frozenBalance must be more than 1BOS");
    }

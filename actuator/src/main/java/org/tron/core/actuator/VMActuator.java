...
import static org.bos.core.vm.utils.MUtil.transfer;
import static org.bos.core.vm.utils.MUtil.transferToken;
...
import org.bos.common.runtime.InternalTransaction.ExecutorType;
...
import org.bos.core.vm.LogInfoTriggerParser;
import org.bos.core.vm.VM;
import org.bos.core.vm.VMConstant;
import org.bos.core.vm.VMUtils;
import org.bos.core.vm.config.ConfigLoader;
import org.bos.core.vm.config.VMConfig;
import org.bos.core.vm.program.Program;
import org.bos.core.vm.program.Program.JVMStackOverFlowException;
import org.bos.core.vm.program.Program.OutOfTimeException;
import org.bos.core.vm.program.Program.TransferException;
import org.bos.core.vm.program.ProgramPrecompile;
...
import org.bos.core.vm.repository.RepositoryImpl;
...
public class VMActuator implements Actuator2 {
  ...
  @Getter
  @Setter
  private InternalTransaction.BosType trxType;
  ...
  public void validate(Object object) throws ContractValidateException {
    ...
    trx = context.getBosCap().getInstance();
    ...
    switch (contractType.getNumber()) {
      case ContractType.TriggerSmartContract_VALUE:
        trxType = BosType.BOS_CONTRACT_CALL_TYPE;
        call();
        break;
      case ContractType.CreateSmartContract_VALUE:
        trxType = BosType.BOS_CONTRACT_CREATION_TYPE;
        create();
        break;
      default:
  ...
  public void execute(Object object) throws ContractExeException {
    ...
    try {
      if (vm != null) {
        ...
        if (BosType.BOS_CONTRACT_CREATION_TYPE == trxType && !result.isRevert()) {
  ...
  private void create()
    ...
    try {
      ...
      ProgramInvoke programInvoke = programInvokeFactory
          .createProgramInvoke(BosType.BOS_CONTRACT_CREATION_TYPE, executorType, trx,
  ...
  private void call()
    ...
    if (isNotEmpty(code)) {
      ...
      long vmShouldEndInUs = vmStartInUs + thisTxCPULimitInUs;
      ProgramInvoke programInvoke = programInvokeFactory
          .createProgramInvoke(BosType.BOS_CONTRACT_CALL_TYPE, executorType, trx,
              tokenValue, tokenId, blockCap.getInstance(), repository, vmStartInUs,
              vmShouldEndInUs, energyLimit);
      if (isConstantCall) {
  ...
  public long getTotalEnergyLimitWithFixRatio(AccountCapsule creator, AccountCapsule caller,
    ...
    if (Arrays.equals(creator.getAddress().toByteArray(), caller.getAddress().toByteArray())) {
      ...
      // which will cost the feeLimit BOS when the creator's frozen energy is 0.

...
import static org.bos.core.actuator.ActuatorConstant.ACCOUNT_EXCEPTION_STR;
import static org.bos.core.actuator.ActuatorConstant.NOT_EXIST_STR;
import static org.bos.core.actuator.ActuatorConstant.WITNESS_EXCEPTION_STR;
import static org.bos.core.config.Parameter.ChainConstant.MAX_VOTE_NUMBER;
import static org.bos.core.config.Parameter.ChainConstant.BOS_PRECISION;
...
import org.bos.protos.contract.WitnessContract.VoteWitnessContract.Vote;
...
public class VoteWitnessActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    try {
      ...
      long bosPower = accountCapsule.getBosPower();

      sum = LongMath.checkedMultiply(sum, BOS_PRECISION); //trx -> drop. The vote count is based on BOS
      if (sum > bosPower) {
        throw new ContractValidateException(
            "The total number of votes[" + sum + "] is greater than the bosPower[" + bosPower
                + "]");
      }

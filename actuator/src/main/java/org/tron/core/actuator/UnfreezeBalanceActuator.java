...
import org.bos.protos.Protocol.Account.AccountResource;
import org.bos.protos.Protocol.Account.Frozen;
...
public class UnfreezeBalanceActuator extends AbstractActuator {
  ...
  public boolean execute(Object result) throws ContractExeException {
    ...
    switch (unfreezeBalanceContract.getResource()) {
      case BANDWIDTH:
        dynamicStore
            .addTotalNetWeight(-unfreezeBalance / BOS_PRECISION);
        break;
      case ENERGY:
        dynamicStore
            .addTotalEnergyWeight(-unfreezeBalance / BOS_PRECISION);
        break;
      default:
        //this should never happen
        break;

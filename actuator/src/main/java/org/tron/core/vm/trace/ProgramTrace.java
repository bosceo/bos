 ...
 */
package org.bos.core.vm.trace;

import static java.lang.String.format;
import static org.bos.common.utils.ByteArray.toHexString;
import static org.bos.core.db.TransactionTrace.convertToBosAddress;
import static org.bos.core.vm.trace.Serializers.serializeFieldsOnly;
...
public class ProgramTrace {
  ...
  public ProgramTrace(VMConfig config, ProgramInvoke programInvoke) {
    if (programInvoke != null && config.vmTrace()) {
      contractAddress = Hex
          .toHexString(convertToBosAddress(programInvoke.getContractAddress().getLast20Bytes()));
    }
  }

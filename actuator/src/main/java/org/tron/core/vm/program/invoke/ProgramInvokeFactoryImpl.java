 ...
 */
package org.bos.core.vm.program.invoke;
...
import static org.bos.common.utils.WalletUtil.generateContractAddress;
...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.BosType trxType,
    ...
    if (trxType == BOS_CONTRACT_CREATION_TYPE) {
    ...
    } else if (trxType == BOS_CONTRACT_CALL_TYPE) {

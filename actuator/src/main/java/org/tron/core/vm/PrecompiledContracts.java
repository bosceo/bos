...
package org.bos.core.vm;

import static org.bos.common.runtime.vm.DataWord.WORD_SIZE;
import static org.bos.common.utils.BIUtil.addSafely;
import static org.bos.common.utils.BIUtil.isLessThan;
import static org.bos.common.utils.BIUtil.isZero;
import static org.bos.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.bos.common.utils.ByteUtil.bytesToBigInteger;
import static org.bos.common.utils.ByteUtil.numberOfLeadingZeros;
import static org.bos.common.utils.ByteUtil.parseBytes;
import static org.bos.common.utils.ByteUtil.parseWord;
import static org.bos.common.utils.ByteUtil.stripLeadingZeroes;
import static org.bos.core.db.TransactionTrace.convertToBosAddress;
...
import org.bos.common.crypto.SignatureInterface;
import org.bos.common.crypto.zksnark.BN128;
import org.bos.common.crypto.zksnark.BN128Fp;
import org.bos.common.crypto.zksnark.BN128G1;
import org.bos.common.crypto.zksnark.BN128G2;
import org.bos.common.crypto.zksnark.Fp;
import org.bos.common.crypto.zksnark.PairingCheck;
  ...
  public static class ValidateMultiSign extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] rawData) {
      ...
      byte[] combine = ByteUtil
          .merge(convertToBosAddress(addr), ByteArray.fromInt(permissionId), data);
      ...
      AccountCapsule account = this.getDeposit().getAccount(convertToBosAddress(addr));
      if (account != null) {
        try {

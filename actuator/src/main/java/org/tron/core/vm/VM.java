...
import static org.bos.core.vm.OpCode.CALL;
import static org.bos.core.vm.OpCode.CALLTOKEN;
import static org.bos.core.vm.OpCode.CALLTOKENID;
import static org.bos.core.vm.OpCode.CALLTOKENVALUE;
import static org.bos.core.vm.OpCode.CREATE2;
import static org.bos.core.vm.OpCode.EXTCODEHASH;
import static org.bos.core.vm.OpCode.ISCONTRACT;
import static org.bos.core.vm.OpCode.PUSH1;
import static org.bos.core.vm.OpCode.REVERT;
import static org.bos.core.vm.OpCode.SAR;
import static org.bos.core.vm.OpCode.SHL;
import static org.bos.core.vm.OpCode.SHR;
import static org.bos.core.vm.OpCode.TOKENBALANCE;
...
public class VM {
  ...
  private boolean isDeadAccount(Program program, DataWord address) {
    return program.getContractState().getAccount(convertToBosAddress(address.getLast20Bytes()))
        == null;
  }
}

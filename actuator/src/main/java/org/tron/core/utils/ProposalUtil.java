...
import org.bos.core.config.Parameter.ForkBlockVersionEnum;
...
//      }
  ...
  public enum ProposalType {         // current value, value range
    ...
    ACCOUNT_UPGRADE_COST(1), // 9999 BOS, [0, 100000000000] BOS
    CREATE_ACCOUNT_FEE(2), // 0.1 BOS, [0, 100000000000] BOS
    TRANSACTION_FEE(3), // 10 Sun/Byte, [0, 100000000000] BOS
    ASSET_ISSUE_FEE(4), // 1024 BOS, [0, 100000000000] BOS
    WITNESS_PAY_PER_BLOCK(5), // 16 BOS, [0, 100000000000] BOS
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 BOS, [0, 100000000000] BOS
    CREATE_NEW_ACCOUNT_FEE_IN_SYSTEM_CONTRACT(7), // 0 BOS, [0, 100000000000] BOS
    ...
    ENERGY_FEE(11), // 10 Sun, [0, 100000000000] BOS
    EXCHANGE_CREATE_FEE(12), // 1024 BOS, [0, 100000000000] BOS
    ...
    UPDATE_ACCOUNT_PERMISSION_FEE(22), // 100 BOS, [0, 100000] BOS
    MULTI_SIGN_FEE(23), // 1 BOS, [0, 100000] BOS
